...
import static com.example.formvalidator.ValidationStyle.BASIC;
import static com.example.formvalidator.ValidationStyle.COLORATION;
import static com.example.formvalidator.ValidationStyle.TEXT_INPUT_LAYOUT;
import static com.example.formvalidator.ValidationStyle.UNDERLABEL;
...
import com.example.formvalidator.AwesomeValidation;
import com.example.formvalidator.ValidationStyle;
import com.example.formvalidator.utility.RegexTemplate;
...
public class DemoActivity extends AppCompatActivity {
    ...
    private void addValidationForEditText(Activity activity) {
        ...
        mAwesomeValidation.addValidation(activity, R.id.edt_year, Range.create(1900, Calendar.getInstance().get(Calendar.YEAR)), R.string.err_year);
        mAwesomeValidation.addValidation(activity, R.id.edt_height, Range.create(0.0f, 2.72f), R.string.err_height);
    ...
    private void addValidationForTextInputLayout(Activity activity) {
        ...
        mAwesomeValidation.addValidation(activity, R.id.til_year, Range.create(1900, Calendar.getInstance().get(Calendar.YEAR)), R.string.err_year);
        setValidationButtons();
    }
